						...
						<div class="modal-body">
							<div class="row">
								<div class="col-sm-4">
									...
									<button type="button" id="selectAllHeads" class="btn btn-info btn-xs pull-right" style="margin-right:5px;">
								...
								<div class="col-sm-4">
									<label for="selected_payamount">Payhead Amount Details</label>
