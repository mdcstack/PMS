													...
													<div class="col-lg-3">
														<div class="form-group">
															...
															<select class="form-control" name="identity_doc" id="identity_doc" required>
																...
																<option value="Philippine Id" <?php echo $data['identity_doc']=='Philippine Id'?'selected':''; ?>>Philippine Id</option>
													...
													<div class="col-lg-3">
														<div class="form-group">
															...
															<select class="form-control" name="emp_type" id="emp_type" required>
																...
																<option value="Regular Employee" <?php echo $data['emp_type']=='Regular Employee'?'selected':''; ?>>Regular Employee</option>
															</select>
														</div>
													</div>
													<div class="col-lg-3">
